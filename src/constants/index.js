import {
  ...
  const projects = [
    ...
    },
    {
      name: "FilmFinder",
      description:
        "Create a web platform for users to access the latest movies, browse new releases, search for specific films, and explore different movie genres.",
      tags: [
        {
          name: "react",
          color: "blue-text-gradient",
      ...
      image: DisneyPlus,
      source_code_link: "https://github.com/Theogama/filmfinder",
    },
    {
      name: "Ai-Summerizer",
      description:
      ...
      image: summerizer,
      source_code_link: "https://github.com/Theogama/Ai_summerizer",
    },
  ];
